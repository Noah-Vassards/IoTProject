...
const createComponent_dto_1 = require("../components/dto/createComponent.dto");
const createAlarm_dto_1 = require("../alarms/dto/createAlarm.dto");
let UsersController = class UsersController {
    ...
    async registerComponent(userId, createComponentDto) {
    ...
    async registerAlarm(userId, createAlarmDto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, createComponent_dto_1.CreateComponentDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, createAlarm_dto_1.CreateAlarmDto]),
    __metadata("design:returntype", Promise)
