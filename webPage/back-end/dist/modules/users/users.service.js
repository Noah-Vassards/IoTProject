...
let UsersService = class UsersService {
    constructor(userRepository, tokenService, componentService, alarmService) {
    ...
    async registerComponent(id, createComponentDto) {
    ...
    async registerAlarm(id, createAlarmDto) {
